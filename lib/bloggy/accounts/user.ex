defmodule Bloggy.Accounts.User do
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Bloggy.Repo)
  ...
  defp validate_password(changeset, opts) do
    ...
    |> validate_length(:password, min: 3, max: 72, message: "should be at least 3 characters")
  ...
  """
  def valid_password?(%Bloggy.Accounts.User{hashed_password: hashed_password}, password)
